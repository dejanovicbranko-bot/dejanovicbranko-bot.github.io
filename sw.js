const CACHE='gridledger-mobile-v3-2-bots-tax-1';
const STATIC_ASSETS=[
  './styles.css','./app.js','./manifest.webmanifest',
  './icon-192.png','./icon-512.png','./cloud-sync.js','./history-fix.js','./ui-v32.js'
];
...
async function injectBridges(response){
  ...
  for(const f of ['cloud-sync.js','history-fix.js','ui-v32.js']){
